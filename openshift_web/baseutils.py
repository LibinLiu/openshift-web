...
def login_by_form(classself,username,password):
    wait_element_present_by_xpath(classself,"//div[@class='content']/div[@id='login-form']/form/label/*[@id='login_input']")
    input_by_xpath(classself,"//div[@class='content']/div[@id='login-form']/form/label/*[@id='login_input']",username)
    input_by_id(classself,"//div[@class='content']/div[@id='login-form']/form/label/*[@id='pwd_input']",password)
    classself.driver.find_element_by_css_selector("div.content>div#login-form>form>input.button").click()
    time.sleep(5)
...
def change_password(classself,user,oldpwd,newpwd,newpwdcfm):
    go_to_home(classself)
    time.sleep(4)
    go_to_signin(classself)
    ...
    input_by_name(classself,"old_password",oldpwd)
