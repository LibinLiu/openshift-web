...
class Flex(unittest.TestCase):
    ...
    def test_check_flex_navi(self):
        #baseutils.go_to_home(self)
        baseutils.go_to_flex(self)
        baseutils.click_element_by_xpath(self,"//a[contains(text(),'Sign up to try Flex!')]")
        ...
        baseutils.assert_text_equal_by_css(self,"OpenShift Flex","span.productname")
