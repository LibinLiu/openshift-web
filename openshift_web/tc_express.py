...
class Express(unittest.TestCase):
    ...
    def test_check_express_quick_start_links(self):
        #baseutils.go_to_home(self)
        baseutils.go_to_express(self)
        ...
        baseutils.check_title(self,"Deploying a Pyramid application in a virtual Python WSGI environment on Red Hat OpenShift Express | Red Hat Openshift Community")
        baseutils.go_back(self)
        #self.driver.execute_script("window.scrollTo(0, document.body.scrollHeight/2);")
